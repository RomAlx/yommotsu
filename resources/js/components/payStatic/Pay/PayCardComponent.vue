                ...
                <div class="container payment-card" :class="bank">
                    <div class="row align-items-center">
                        <div class="col-7 to-left-side">
                            ...
                            <h5 class="card-fill-small">{{this.order.bank.name}}</h5>
                        </div>
                    ...
                    <div class="row second-half">
                        <div class="col-9 to-left-side">
                            ...
                            <h5 class="card-fill-big" id="bank-number">{{this.order.bank.bank_number}}</h5>
                        </div>
...
export default {
  ...
  computed: {
        bank() {
            ...
            return this.order.bank.bank;
        },
        srcLogo () {
            return '/img/paycard/'+this.order.bank.bank+'.png';
        },
        logobank () {
            return 'logo-' + this.order.bank.bank;
        }
  },
  methods: {
      getBack() {
