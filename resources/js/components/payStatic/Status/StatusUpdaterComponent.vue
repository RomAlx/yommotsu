...
import ErrorComponent from './StatusErrorComponent.vue';
import WarningComponent from './StatusWarningComponent.vue';
import SuccessComponent from './StatusSuccessComponent.vue';
import TimerComponent from './StatusTimerComponent.vue';
